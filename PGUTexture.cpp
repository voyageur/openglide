// PGUTexture.cpp: implementation of the PGUTexture class.
//
//////////////////////////////////////////////////////////////////////
...
GrMipMapId_t PGUTexture::AllocateMemory(GrChipID_t tmu, FxU8 odd_even_mask, int width, int height,
...
{
    return (mmid >= 0 && mmid < MAX_MM && mm_info[mmid].valid) ? &(mm_info[mmid]) : NULL;
}

FxBool PGUTexture::ChangeAttributes(GrMipMapId_t mmid, int width, int height, GrTextureFormat_t fmt, GrMipMapMode_t mm_mode, GrLOD_t smallest_lod, GrLOD_t largest_lod, GrAspectRatio_t aspect, GrTextureClampMode_t s_clamp_mode, GrTextureClampMode_t t_clamp_mode, GrTextureFilterMode_t minFilterMode, GrTextureFilterMode_t magFilterMode)
{
    return FXFALSE;
}
